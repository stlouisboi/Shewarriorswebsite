...
const PLACES = [
  ...
  { num: "05", icon: HeartHandshake, name: "Fund the Mission", tag: "For donors, sponsors, and supporters helping SHE Warriors grow programs, gatherings, and access.", text: "Help make room for another woman to flourish.", cta: "Help Set the Table", to: "/give" },
];
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <Reveal>
            ...
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-parchment/85 md:text-lg">
              SHE Warriors is building a faith-filled sisterhood where women and girls can
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <SectionHead num="01" title="Join the Sisterhood" accent="Come as you are. Find your people.">
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-parchment/85">
              This is why SHE Warriors exists. Whatever season you're in and whatever
      ...
      <section data-testid="section-partner" className="scroll-mt-32 bg-espresso">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32">
          <SectionHead num="04" title="It Takes a Village to Build" accent="a Safe Place for Women to Flourish.">
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-parchment/85">
              SHE Warriors is a trusted connector and convener — not a counseling center,
