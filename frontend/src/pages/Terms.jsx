...
const SECTIONS = [
  {
    ...
    body: `This website is operated by S.H.E. Warriors Foundation, a registered 501(c)(3) nonprofit organization. By using this site you agree to these terms. If you do not agree, please do not use the site.`,
  },
  {
...
If you are in immediate danger, call 911. If you are in emotional distress or crisis, call or text 988 (Suicide & Crisis Lifeline) or text HOME to 741741. These services are staffed by professionals; we are not a crisis service.`,
  ...
  },
  {
    ...
    body: `The S.H.E. Warriors name, logo, and the text and design of this site belong to S.H.E. Warriors Foundation. You may share links to our pages freely; please do not reproduce our content or branding for commercial purposes without written permission.`,
  },
  {
    title: "7. Limitation of liability",
    body: `This site is provided "as is" without warranties of any kind. To the fullest extent permitted by law, S.H.E. Warriors Foundation is not liable for any damages arising from your use of the site or reliance on its content.`,
  },
  {
    title: "8. Changes and contact",
    body: `We may update these terms from time to time; the version posted here is the current one. Questions: legal@sheworriers.org or S.H.E. Warriors Foundation, P.O. Box 412.`,
  },
];
