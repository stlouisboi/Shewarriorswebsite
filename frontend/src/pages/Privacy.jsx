...
If a request indicates someone may be in immediate danger, we may encourage that person — through the resources on our site — to contact 988 or 911. We are not a crisis service and cannot respond to emergencies; the Immediate Help banner exists for that reason.`,
  ...
  {
    title: "3. Donations",
    body: `When our giving portal launches, payment details will be processed by a PCI-compliant payment processor. S.H.E. Warriors Foundation will never see or store your full card number. We will retain only the information needed to issue your tax-deductible receipt (name, email, and gift amount).`,
  },
  {
  ...
  },
  {
    ...
    body: `If we change this policy, we will post the updated version here with a new effective date. Questions can be sent to privacy@sheworriers.org or S.H.E. Warriors Foundation, P.O. Box 412.`,
  },
];
