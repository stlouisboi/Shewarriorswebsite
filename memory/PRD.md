...
- REBRAND FINAL (2026-08-12): Brand is "SheWorriers" with slogan "Sisterhood. Healing. Empowerment." — per user's uploaded logo set (dark + cream/gold versions). Cream version keyed to transparency (logo-full.png, logo-emblem.png in public/assets). Nav = emblem + wordmark + tagline; footer = large full logo. Site text reverted from "SHE Warriors" back to "SheWorriers". Page title updated.
