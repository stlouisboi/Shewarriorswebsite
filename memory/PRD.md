...
- REBRAND (2026-08-11): "SheWorriers" → "SHE Warriors" site-wide (nav, footer, all pages, backend emails, Stripe product names, page title). Old slogan "From Worry to Worship" removed — user will supply a new one. Footer now shows emblem-only image + "SHE WARRIORS" text until user uploads a new logo file. Contact emails still @sheworriers.org (domain unchanged — confirm with user).
